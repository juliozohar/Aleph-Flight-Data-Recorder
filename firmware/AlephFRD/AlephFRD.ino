...
float valSensor  = 0;  //Armazena o valor lido pelo sensor
float temp_raw = 0;  //Armazena a temperatura bruta 
float temp     = 0;  //Armazena a tempeatura calibrada
...
*/
void loop() {
	//Code to look for commands issued by user
...
/*
  Reads the temperature from analog sensor. 
*/
void get_temp_int(){
  temp_raw = 0; 
...
/*
  Converts reading into celcius degrees. 
*/
...
void write_record(){
		char tmp_cont[6];    //TODO: optimize this
                ...
                String ts =  TempoReal.getTimestamp();
		raw001a += REG_TYPE; 
		raw001a += REG_NAME; 
...
*/
void showdate(){
	Serial.println(TempoReal.getTimestamp());
}
